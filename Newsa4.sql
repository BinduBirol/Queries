/* Formatted on 4/23/2018 4:52:23 PM (QP5 v5.227.12220.39754) */
  SELECT *
    FROM (SELECT bnm.BILL_ID,
           ...
           WHERE BNM.BILL_MONTH = MM.M_ID AND bnm.CUSTOMER_ID = '190104692'
          UNION ALL
          SELECT NULL BILL_ID,
                 CUSTOMER_ID,
                 getBankBranch (BRANCH_ID) BANK_NAME,
           ...
           WHERE status = 1 AND CUSTOMER_ID = '190104692')
ORDER BY BILL_ID